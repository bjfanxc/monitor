<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="channelList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="渠道名称" align="center" prop="name" min-width="160" :show-overflow-tooltip="true" />
  ...
  data() {
    return {
      ...
      rules: {
        ...
        botToken: [{ required: true, message: "Bot Token不能为空", trigger: "blur" }],
        chatId: [{ required: true, message: "Chat ID不能为空", trigger: "blur" }]
      }
    }
  },
  created() {
